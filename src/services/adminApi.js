...
export const getAdminAiInsights = () => request('/admin/ai-insights')
export const adoptAdminAiFact = (data) => request('/admin/ai-insights/adopt-fact', json('POST', data))
export const getAdminProfiles = () => request('/admin/profiles')
export const publishAdminProfile = (id) => request(`/admin/profiles/${id}/publish`, { method: 'POST' })
